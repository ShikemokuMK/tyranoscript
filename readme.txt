TyranoScript｜ティラノスクリプト　Ver5.0（C）ShikemokuMK
http://tyrano.jp
...
---------------------------------------------------------------------
Ver5.0 (2019/03/12)
作家:Alberto Salvia Novella (es20490446e.wordpress.com)
Linuxで動作します
.savファイル名がわかりやすくなりました
多くのゲームは新しいゲームの前にそれを変更することを許可していないので、ゲームはデフォルトでフルスクリーンで起動します。
最終的なゲームをより整理するために、ライセンスファイルはtyranoフォルダに移動されました。
